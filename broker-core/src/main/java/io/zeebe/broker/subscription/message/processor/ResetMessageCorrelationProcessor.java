...
public class ResetMessageCorrelationProcessor
  ...
  public ResetMessageCorrelationProcessor(final MessageState messageState) {
    this.messageState = messageState;
  }

  // TODO: add message key to exported record
  @Override
  public void processRecord(
    ...
    streamWriter.appendNewCommand(MessageSubscriptionIntent.CORRELATE, subscriptionRecord);
  }
}
